...
%             u_series = tools.remove_initial_time(u_series, T_0, T_f);
    ...
    ref_signal = forcing_func_series.Data(:);
    ...
    elseif idx == 2
        ...
        legend(line, 'r', 'y_s', 'FontSize', 10, 'NumColumns', 2, 'Location', 'northwest');
    end
    xlim([0, 90]);
    set(gca,'FontSize', 10);
end
set(fig_,'Position',[10 10 800 (250 * length(conditions))]);
exportgraphics(fig_, join(["results/images/", condition, "_steady_output_shade.pdf"], ""));
