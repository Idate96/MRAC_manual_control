...
for subject = subjects
    ...
    for exp_data = mean_unsteady_runs
        ...
        up = [0.20, 0.15, 0.20, 3.3, 0.25, 100, 100, 100];
        ...
        path = join(['results/tests/', exp_data.subjectname, '/', name_file, 'red_3_.mat']);

        optimal_params = cases.optimize_pursuit_u_reduced(exp_data, params, lb, up, path);
    end
end
