column_names = {'Subject', 'Dynamics', 'FOFU',  'VAF y', 'VAF u', 'RMSE', 'RMSU', ...
...
table_results = table(subject_t, dyn_t, fofus_t, vafs_y_t, vafs_u_t, mse_t, msu_t, ...
...
%%
save('results/results_table_training.mat', 'table_results');