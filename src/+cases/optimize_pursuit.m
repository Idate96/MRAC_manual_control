...
%     assignin('base', 'case_', condition_id)
    ...
    %%
    % sim
    find_mse_func = @(model_params_norm) fitting.find_mse_mrac_pursuit(y, model_func, model_params_norm, lb, up);
    optimal_param = fitting.fit_mrac_pursuit(r, find_mse_func, params_0n, lb_n, up_n);
