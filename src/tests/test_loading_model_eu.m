...
for subject = subjects
    for fofu = fofus
        ...
        load(join(["results/tests/", subject, "/", common_name, "delay_eu.mat"], ""));
        ...
        saveas(gcf, join(["results/images/", subject, "/", common_name, "delay_out_eu.png"], ""));
        
        tools.plot_comparison_u(u_series, mrac_output, "test");
        tools.plot_areas(gcf, dynamics_str)
        saveas(gcf, join(["results/images/", subject, "/", common_name, "delay_u_eu.png"], ""));

        tools.plot_gains(mrac_output);
        tools.plot_areas(gcf, dynamics_str)
        saveas(gcf, join(["results/images/", subject, "/", common_name, "delay_gains_eu.png"], ""));
    end
end
