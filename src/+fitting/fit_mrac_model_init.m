function [params] = fit_mrac_model_init(reference_signal, human_output, model_func, params_0n, lb, up)
%     model_func = @models.integrator_delay;
    ...
    params = fmincon(find_mse_func, params_0n, [],[],[],[], lb, [1, 1, 1, 1, 1, 1, 1, 1], [], options);
end 